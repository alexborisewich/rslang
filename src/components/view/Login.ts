    ...
    return `<section class="auth">
        <div class="auth__container">
          <div class="auth__form-wrapper">
            ...
            <form class="auth__form form " id="" action="#" autocomplete="on">
              <h2 class="form__title">Войти</h2>
              <div class="form__message"></div>
              <ul class="form__input-list">
                <li class="form__input-item">
                  <input class="form__input" id="email" type="email" autofocus placeholder="Email" required>
                  <div class="form__input-message"></div>
                </li>
                <li class="form__input-item">
                  <input type="password" class="form__input" autofocus placeholder="Пароль" required>
                  <div class="form__input-message"></div>
                </li>
                <li class="form__input-item">
