        ...
        <div class="textbook__workspace">
          ...
          <ul class="textbook__level-list">
            <li class="textbook__level-item">
              <button><span>Elementary</span><span>A1</span></button>
            </li>
            <li class="textbook__level-item">
              <button><span>Pre-Intermediate</span><span>A2</span></button>
            </li>
            <li class="textbook__level-item">
              <button><span>Intermediate</span><span>B1</span></button>
            </li>
            <li class="textbook__level-item">
              <button><span>Upper-Intermediate</span><span>B2</span></button>
            </li>
            <li class="textbook__level-item">
              <button><span>Advanced</span><span>C1</span></button>
            </li>
            <li class="textbook__level-item">
              <button><span>Proficiency</span><span>C2</span></button>
            </li>
          </ul>
