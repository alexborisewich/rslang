...
<<<<<<< HEAD
            <ul class="games__level-list">
              ...
              <li class="games__level-item">
                <input class="games__level-input" type="radio" value="1" name="level-select">
              ...
              <li class="games__level-item">
                <input class="games__level-input" type="radio" value="2" name="level-select">
              ...
              <li class="games__level-item">
                <input class="games__level-input" type="radio" value="3" name="level-select">
              ...
              <li class="games__level-item">
                <input class="games__level-input" type="radio" value="4" name="level-select">
              ...
              <li class="games__level-item">
                <input class="games__level-input" type="radio" value="5" name="level-select">
